...
@Component({
  selector: 'app-customer-with-drawn',
  templateUrl: './customer-with-drawn.component.html',
  styleUrls: ['./customer-with-drawn.component.scss']
})
export class CustomerWithDrawnComponent implements OnInit {

  customerid!:any;
  withdrawnCustomerForm!: FormGroup ;
  account = new Account();
  ...
  ngOnInit(): void {
    ...
    this.withdrawnCustomerForm = this.formBuilder.group({
